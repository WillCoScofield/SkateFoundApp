...
const SensTab = () => {
  ...
  return (
    <View>
      <Text>
      Sensory deficiency is a fact of T21
      </Text>
      ...
      <Text>
      There are endless methods of therapies available to enable proper breathing, swallowing and articulate speech. The <Text onPress={() =>
                Linking.openURL("http://www.myofunctionaltherapy.org/")
              }>Institute of Myofunctional Studies </Text> website provides a clear overview for how to begin to interpret the symptoms and solutions. 
        </Text>
