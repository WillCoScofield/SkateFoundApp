  ...
  return (
    ...
    <View>
      ...
      <Text>
        ...
        abnormalities in their children with T21. Professor Sally Shot, MD
        conducted clinical studies which successfully led to the American
        Academy of Pediatrics to lower recommendations for earlier testing for
        sleep apnea to age three. Although a huge achievement, it has been
        proven to appear in as early as the first few months of life. This,
        coupled with the critical brain development which occurs in the first
        three years Families and cares are strongly urged to begin testing and
        to continue testing and overnight sleep studies from six months onward.
        A parent should have a short checklist with them when asking their
        pediatrician to prescribe sleep studies:
      </Text>
      ...
      <Text>Issue 4</Text>
      <Text>
        A large percentage of small children with T21 are unable to snore. And
        without audible snoring, tossing and turning, or other extremely
